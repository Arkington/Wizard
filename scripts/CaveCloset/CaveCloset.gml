...
hat_intro_2 = {
	...
	main_1: [
	    Page(spkHatrickNeutral, "hi... Hi!", {"center_text":true}),
	    Page(spkAxel, "Hi.", {"center_text":true}),
	    Page(spkHatrickNeutral, "Hi. Hey. I... kinda saw you shoot that guy... with |S|MAGIC/S/! It was... kinda cool.", {"center_text":true}),
	    Page(spkAxel, "Thanks.", {"center_text":true}),
	    Page(spkHatrickNeutral, "...you must be some sort of wizard, right?", {"center_text":true}),
	    Page(spkHatrickNeutral, "...some kinda |S|MAGIC/S/ man???", {"center_text":true}),
	    Page(spkAxel, "It's literally my first day learning magic.", {"center_text":true}),
	    Page(spkHatrickNeutral, "No way.", {"center_text":true}),
	    Page(spkAxel, "Yes way.", {"center_text":true}),
	    Page(spkHatrickNeutral, "Wow, I've never seen magic like that before in my entire life.", {"center_text":true}),
	    Page(spkAxel, "Really?"),

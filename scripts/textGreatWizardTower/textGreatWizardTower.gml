...
hatrick_intro_conversation = {
	...
	main_1: TextNode(
	    [
	        Page(spkHatrickNeutral, "|S|hi.../S/ Hi!"),
	        Page(spkAxelNeutral, "Hi."),
	        Page(spkHatrickNeutral, "Hi. Hey. I... |S|kinda saw you shoot that guy/S/... with |V||B|MAGIC/V/|W|! It was... kinda cool."),
	        Page(spkAxelNeutral, "Thanks."),
	        Page(spkHatrickNeutral, "...you must be some sort of wizard, right?"),
	        Page(spkHatrickNeutral, "...some kinda |V||B|MAGIC/V/|W| man???"),
	        ...
	        Page(spkAxelNeutral, "I'm |T|Axel|W|."),
	...
	early_bye: TextNode(
	    [
	        Page(spkHatrickNeutral, "WAIT don't go I haven't talked to anyone in a really long time..."),
	        Page(spkAxelNeutral, "...")
	    ],
	    NO_CHOICES,
	    "main_2"
	...
	name_hat: TextNode(
	    [
	        Page(spkHatrickNeutral, "Heeee... nice to meet you too.")
	    ],
	    NO_CHOICES,
	    NO_NEXT_NODE
	),
	name_hatrick: TextNode(
	    [
	        Page(spkHatrickNeutral, "Yeah... yeah that sounds cool!"),
	...
	name_hatty: TextNode(
	    [
	        ...
	        Page(spkHatrickNeutral, "I... I have a nickname..."),
	        Page(spkHatrickNeutral, "..."),

...
var keyUp = keyboard_check(KEY_MOVE_UP);
var keyLeft = keyboard_check(KEY_MOVE_LEFT);
var keyDown = keyboard_check(KEY_MOVE_DOWN);
var keyRight = keyboard_check(KEY_MOVE_RIGHT);
